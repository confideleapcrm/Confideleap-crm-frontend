...
//       // Support legacy format (array of companyIds) and new object format
//       let pref: any;
...
//       // apply the saved preference into filters state
//       setFilters((prev) => ({
//         ...prev,
//         firmTypes: pref.firmTypes || [],
//         sectors: pref.sectors || [],
//         aum: pref.aum || [],
//         buySell: pref.buySell || [],
//         customerIds: pref.customerIds || [],
//       }));
//       // reset pagination to page 1
//       setPage(1);
//     } catch (err) {
//       // silent fail — do not interrupt app
